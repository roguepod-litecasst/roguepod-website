/**
 * Stamps out a real HTML file per episode after the CRA build.
 *
 ...
 * Twitter tags, canonical URL, PodcastEpisode JSON-LD, and a static content
 * block inside #root that React replaces on hydration.
 *
...
function main() {
  ...
  console.log(`Prerendered ${episodes.length} episode pages + /episodes index`);
}
