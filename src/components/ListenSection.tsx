...
import { DiscordIcon, PatreonIcon } from './Icons';
...
/**
 * Community, not listening: the podcast apps live in the hero now. Discord and
 * Patreon each get a full-width block; everything else is a plain tile.
 */
const ListenSection: React.FC = () => (
  <section id="listen" className="mx-auto max-w-content scroll-mt-20 px-5 pt-20 sm:px-8 sm:pt-28">
    <div className="max-w-2xl">
      <p className="eyebrow">Community</p>
      <h2 className="mt-3 text-3xl font-semibold sm:text-4xl">Come say hi</h2>
    </div>

    {/* Discord leads — it's the best way to reach the hosts. */}
    <div className="mt-8 flex flex-col gap-6 border border-ink-600 bg-ink-800 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
      <div className="flex items-start gap-4">
        <span className="mt-0.5 h-7 w-7 shrink-0 text-glitch-blue">
          <DiscordIcon />
        </span>
        <div>
          ...
          <p className="mt-1.5 max-w-md text-sm leading-relaxed text-bone-200">
            The best way to get in touch with us. Suggest a game, argue about a tier, or just hang
            out.
          </p>
        </div>
      </div>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex shrink-0 items-center justify-center border border-ink-500 bg-ink-900 px-6 py-3.5 font-display text-sm font-semibold uppercase tracking-[0.08em] text-bone-100 transition-colors hover:border-bone-300 hover:text-bone-50"
      >
        Join the Discord
      </a>
    </div>
